...
public partial class MainForm : Form
{
    ...
    private static void InitClassicBoard()
    {
        for (var x = 0; x < GameCell.NUM_COLUMNS; x++)
        {
            ...
            _ = new PiecePawn((x, GameCell.NUM_ROWS - 2), PieceColor.Black);
        }

        _ = new PieceGuard((4, 1), PieceColor.White);
        _ = new PieceGuard((4, GameCell.NUM_ROWS - 2), PieceColor.Black);
        _ = new PieceGuard((5, 1), PieceColor.White);
        _ = new PieceGuard((5, GameCell.NUM_ROWS - 2), PieceColor.Black);

        _ = new PieceRook((0, 0), PieceColor.White);
        _ = new PieceRook((0, GameCell.NUM_ROWS - 1), PieceColor.Black);
        ...
        _ = new PieceKnight((1, GameCell.NUM_ROWS - 1), PieceColor.Black);
        _ = new PieceKnight((GameCell.NUM_COLUMNS - 2, 0), PieceColor.White);
        _ = new PieceKnight((GameCell.NUM_COLUMNS - 2, GameCell.NUM_ROWS - 1), PieceColor.Black);

        _ = new PieceBishop((2, 0), PieceColor.White);
        _ = new PieceBishop((2, GameCell.NUM_ROWS - 1), PieceColor.Black);
        _ = new PieceBishop((GameCell.NUM_COLUMNS - 3, 0), PieceColor.White);
        _ = new PieceBishop((GameCell.NUM_COLUMNS - 3, GameCell.NUM_ROWS - 1), PieceColor.Black);

        _ = new PieceChancellor((3, 0), PieceColor.White);
        _ = new PieceChancellor((3, GameCell.NUM_ROWS - 1), PieceColor.Black);
        _ = new PieceCardinal((6, 0), PieceColor.White);
        _ = new PieceCardinal((6, GameCell.NUM_ROWS - 1), PieceColor.Black);

        _ = new PieceQueen((4, 0), PieceColor.White);
        _ = new PieceQueen((4, GameCell.NUM_ROWS - 1), PieceColor.Black);
        _ = new PieceKing((5, 0), PieceColor.White);
        _ = new PieceKing((5, GameCell.NUM_ROWS - 1), PieceColor.Black);
    }
